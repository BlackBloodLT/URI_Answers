 ...
 * ultrapasse a cidade B em população. Claro que ela quer saber apenas
 * para as cidades cuja taxa de crescimento da cidade A é maior do
 * que a taxa de crescimento da cidade B, portanto, previamente já
 * separou para você apenas os casos de teste que tem a taxa de
 * crescimento maior para a cidade A. Sua tarefa é construir um
 ...
 * não se interessa em saber exatamente o tempo para estes casos.
 ...
 * número de casos de teste (1 ≤ T ≤ 3000). Cada caso de teste contém
 * 4 números: dois inteiros PA e PB (100 ≤ PA < 1000000, PA < PB ≤ 1000000)
 ...
 * decimal cada, indicando respectivamente o crescimento populacional de
 * A e B (em percentual).
 ...
 * Saída
 * Imprima, para cada caso de teste, quantos anos levará para que a cidade
 * A ultrapasse a cidade B em número de habitantes. Obs.: se o tempo for mais
...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        int casosTestes = scanner.nextInt();

        for(int cont=1 ; cont<=casosTestes ; cont++) {
            ...
            while(populacaoA<=populacaoB) {
                ...
                contadorAnos++;
                // Observação: O programa não precisa calcular valores acima de 100 anos.
                if(contadorAnos>100) {
                    break;
                }
            }
