 ...
 * sobre R$ 2.00, o que resulta em R$ 80.36 no total. O valor deve
 * ser impresso com duas casas decimais.
 * Entrada
 * A entrada contém apenas um valor de ponto flutuante, com duas
 * casas decimais.
 * Saída
 * Imprima o texto "R$" seguido de um espaço e do valor total devido
 * de Imposto de Renda, com duas casas após o ponto. Se o valor de
...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        /**
         * usar String.format para gerar as respostas
         * DecimalFormat e printf não funcionam bem
         */
